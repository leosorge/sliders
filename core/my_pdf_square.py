...
def _make_background() -> ImageReader:
    w, h = PAGE_SIZE
    base_color = (19, 27, 54)
...
def generate_pdf_square(
    summary_text: str,
    title: str,
    date: str,
    footer: str = "Leo Sorge @ CEO Source 2026",
) -> bytes:
    """Returns 842×842 square PDF as bytes."""
    ...
    font_size = 22 * 2 * 0.9 * 1.5      # square: +50% rispetto ad A4
    line_leading = 33 * 2 * 0.9 * 1.5
